(function() {
  ...
  const lastFiberCommitTime = /* @__PURE__ */ new Map();
  ...
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    const tabId = ((_a2 = sender.tab) == null ? void 0 : _a2.id) ?? message.tabId;
    if (!tabId) {
      return;
    }
    ...
    switch (message.type) {
      ...
      case "STALE_CLOSURE_DETECTED": {
        ...
        const existing = state.issues.find(
          (i) => {
            var _a3, _b, _c, _d;
            return i.type === issue.type && i.component === issue.component && ((_b = (_a3 = i.location) == null ? void 0 : _a3.closureInfo) == null ? void 0 : _b.functionName) === ((_d = (_c = issue.location) == null ? void 0 : _c.closureInfo) == null ? void 0 : _d.functionName);
          }
        );
        if (!existing) {
          state.issues.push(issue);
  ...
  if ((_a = chrome.webNavigation) == null ? void 0 : _a.onCommitted) {
