    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "issue-header", onClick: () => setExpanded(!expanded), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "issue-icon", children: severity.icon }),
        ...
        expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "issue-details", children: [
          ...
          (location == null ? void 0 : location.closureInfo) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "closure-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "🔍 Closure Timeline:" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "issue-suggestion", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "💡 Suggestion:" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "issue-actions", children: info.learnUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: info.learnUrl,
              target: "_blank",
...
function UIStateTab({ issues, onClear }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "🎯 UI & State Issues" }),
...
function PerformanceTab({ issues, components, renders, tabId, pageLoadMetrics }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "⚡ Performance Analysis" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: scanEnabled ? "🔍 Scan ON" : "🔍 Scan OFF"
        }
      )
    ] }),
...
function SideEffectsTab({ issues }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "🔄 Side Effects Analysis" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "issue-count", children: [
        filteredIssues.length,
        " issue",
        filteredIssues.length !== 1 ? "s" : ""
...
function CLSTab({ report }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tab-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "📐 Layout Shift (CLS) Monitor" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section cls-score-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cls-score-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cls-rating", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rating-emoji", children: getRatingEmoji(rating) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section info-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "💡 How to Reduce CLS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "tips-list", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Add ",
...
function ReduxTab({ detected, state, actions, tabId }) {
  ...
  if (!detected) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tab-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "🗄️ Redux DevTools" }) }),
...
if (process.env.NODE_ENV === 'development') {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel redux-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "🗄️ Redux DevTools" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "header-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "icon-btn", onClick: refreshState, title: "Refresh State", children: "🔄" }) })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section info-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "💡 State Editing" }),
...
function MemoryTab({ report, tabId }) {
  ...
  if (!(report == null ? void 0 : report.current)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "🧠 Memory Monitor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
